  ...
  return (
    <Box>
      <Text>
        ...
        While you are here, Feel free to <span role="img" aria-label="Signing hand">✍🏽</span> <Link sx={{variant: 'link.highlight'}} href="./sign-the-guestbook/">Sign the Guestbook</Link> to see a live demo of how the action works!
      </Text>
    </Box>
  )
}
